...
Hybrid_Model = HybridModel(DS_0 = 400, DI_0 = 5, CS_0 = 0,CI_0 = 0, k1=0.002, k2=0.1, dt=0.2, tf=40, T1=40, T2=40, gamma=0.5)
combined_model = SISimulation(S0=400, I0=5, k1=0.002, k2=0.1, tf=40, dt=0.2)

timegrid,data_table_cum, combined = Hybrid_Model.run_multiple(total_simulations=100)
